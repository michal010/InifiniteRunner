...
public class ObstacleGenerator : BaseObstacleGenerator
{
    ...
    public override void GenerateObstacles(MapSegmentDataSO data, Transform parent)
    {
        //code to generate obstacles
        //Vector3 obstaclePos = data.
        foreach (var obstacle in data.Obstacles)
        {
            GameObject.Instantiate(obstacle.ObstaclePrefab, obstacle.ObstaclePosition, obstacle.ObstacleQuaterion, parent);
        }
    }
}
